...
class SOOTRunner(CommandLineToolRunner):
    ...
    def get_base_command(self) -> List[str]:
        return "java -jar /SootInterface/target/SootInterface-1.0-SNAPSHOT-jar-with-dependencies.jar --keep-line-number -pp -w --src-lines -p cg.spark enabled:true".split(" ")
