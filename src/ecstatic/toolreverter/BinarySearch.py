...
class BinarySearch():
    ...
    def __init__(self, gitrepo: str, from_tag, to_tag, violations: [PotentialViolation],
                 toolrunner: AbstractCommandLineToolRunner, revert_tool: Reverter, checker: AbstractViolationChecker):
    ...
    def performsearch(self) -> [SearchResult]:
        ...
        for violation in self.violations:
            ...
            while left < right:
                ...
                # TODO:: change to right method
                new_violation = self.checker.check_violations([fjob1,fjob2],"/searchviolations");
